...
function ThingsIlove() {
  return (
    <div className="til container ">
      <h1 className="xtz text-clr display-4 text-center fw-bolder text-capitalize my-5">
        things i love
      </h1>
       <div className="blur blur-shade"></div>

      {/* cards  */}
      <div className="c-container d-flex justify-content-between">
        {
          data.map((value, index) => {
            return(
              <Cards key={index}
               prefix={value.dataPrefix}
               icon={value.dataIcon}
